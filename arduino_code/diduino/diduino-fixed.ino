...
#define rTop 10090.0      // ohm value for R8 accurately measured!! used for internal Voltmeter calibration
#define rBottom 2279.0    // ohm value for R7 accurately measured!! used for internal Voltmeter calibration

//#define rTop 9899.0
//#define rBottom 2195.0
...
float get_voltage (void) {
 // float vADC = (analogRead(voltageControl) / 1024.) * 4.45;
  float vADC = (analogRead(voltageControl) / 1024.) * 5.03;  //// !ATTENTION! for internal Voltmeter calibration
